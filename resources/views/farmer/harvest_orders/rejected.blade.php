    ...
    <table class="w-full table-auto border border-gray-300">
        <thead class="bg-gray-300">
            <tr>
                ...
                <th class="px-3 py-2">Fertilizer Type</th>
        ...
        <tbody>
            @forelse($orders as $order)
                <tr class="border-t text-center">
                    ...
                    <td class="px-3 py-2">{{ $order->fertilizerOrder->type ?? '-' }}</td>
            ...
            @empty
                <tr>
                    <td colspan="8" class="text-center py-4 text-gray-500">No rejected orders found.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
