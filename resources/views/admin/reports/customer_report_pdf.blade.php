...
<head>
    <meta charset="utf-8">
    <title>End Product Life Cycle Details Report - Admin's View</title>
    <style>
...
<body>
    <h2>End Product Life Cycle Details Report - Admin's View</h2>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="6" class="text-center">No confirmed harvest orders found.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
