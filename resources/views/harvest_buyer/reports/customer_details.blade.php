...
<body>
    ...
    <div class="container">
        ...
        <div class="form-wrapper">
            ...
            <dl>
                @php
                    $fields = [
                        ...
                        'Harvest Date' => $data->harvest_date ? \Carbon\Carbon::parse($data->harvest_date)->format('Y-m-d H:i:s') : '—',
                        'Origin' => $data->origin ?? '—',
                        'Seed Provided Date' => $data->seed_provider_date ? \Carbon\Carbon::parse($data->seed_provider_date)->format('Y-m-d H:i:s') : '—',
                        'Fertilizer Type' => $data->fertilizer_type ?? '—',
                        'Fertilizer Applied Date' => $data->fertilizer_applied_date ? \Carbon\Carbon::parse($data->fertilizer_applied_date)->format('Y-m-d H:i:s') : '—',
                    ];
                @endphp
            ...
            <a href="{{ route('harvest_buyer.reports.customers') }}" class="back-button">← Back to Reports</a>
        </div>
    </div>
</body>
</html>
